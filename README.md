...
[1-2]sem - Директория с решениями заданий данного семестра
[1-2]sem/task[1-4] - Директория с решениями заданиями данного модуля
[1-2]sem/task[1-4]/[1-9](_[1-9]|)(.cpp|) - Файл или директория с решением данного задания

Решение прошло все тесты из яндекс-контеста, если не скзано обратное
